...
int main(int argc, char *argv[])
{
  ...
  unsigned char *data = stbi_load("./static/images/textures/container.jpg", &width, &height, &nrChannels, 0);
  ...
  // 加载图片
  data = stbi_load("./static/images/textures/awesomeface.png", &width, &height, &nrChannels, 0);
